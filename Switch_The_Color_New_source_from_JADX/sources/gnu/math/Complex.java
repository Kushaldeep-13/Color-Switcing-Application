...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo11203re().isExact() && mo11202im().isExact();
    }

    /* Debug info: failed to restart local var, previous not found, register: 4 */
    public Complex toExact() {
        RealNum re = mo11203re();
        RealNum im = mo11202im();
    ...
    public Complex toInexact() {
        return isExact() ? this : new DComplex(mo11203re().doubleValue(), mo11202im().doubleValue());
    }
    ...
    public double doubleValue() {
        return mo11203re().doubleValue();
    }

    public double doubleImagValue() {
        return mo11202im().doubleValue();
    }
    ...
    public static boolean equals(Complex x, Complex y) {
        return x.mo11203re().equals(y.mo11203re()) && x.mo11202im().equals(x.mo11202im());
    }
    ...
    public static int compare(Complex x, Complex y) {
        int code = x.mo11202im().compare(y.mo11202im());
        return code != 0 ? code : x.mo11203re().compare(y.mo11203re());
    }
    ...
    public boolean isZero() {
        return mo11203re().isZero() && mo11202im().isZero();
    }

    public String toString(int radix) {
        if (mo11202im().isZero()) {
            return mo11203re().toString(radix);
        }
        String imString = mo11202im().toString(radix) + "i";
        if (imString.charAt(0) != '-') {
            imString = "+" + imString;
        }
        return !mo11203re().isZero() ? mo11203re().toString(radix) + imString : imString;
    }

    public static Complex neg(Complex x) {
        return make(x.mo11203re().rneg(), x.mo11202im().rneg());
    }
    ...
    public static Complex add(Complex x, Complex y, int k) {
        return make(RealNum.add(x.mo11203re(), y.mo11203re(), k), RealNum.add(x.mo11202im(), y.mo11202im(), k));
    }
    ...
    public static Complex times(Complex x, Complex y) {
        RealNum x_re = x.mo11203re();
        RealNum x_im = x.mo11202im();
        RealNum y_re = y.mo11203re();
        RealNum y_im = y.mo11202im();
