...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo11203re() {
        return number().mo11203re();
    }

    /* renamed from: im */
    public RealNum mo11202im() {
        return number().mo11202im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo11203re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo11202im().doubleValue();
    }
