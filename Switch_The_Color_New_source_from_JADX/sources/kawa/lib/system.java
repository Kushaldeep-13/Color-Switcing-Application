...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f271catch;
    ...
    static {
        ...
        f271catch = new ModuleMethod(system2, 9, Lit10, 12291);
    ...
    public static Process makeProcess(Object args, Object env) {
        ...
        } else if (C0654lists.isList(args)) {
    ...
    public static Object convertListToStringArray(Object lst) {
        try {
            String[] arr = new String[C0654lists.length((LList) lst)];
            int i = 0;
            Object p = lst;
            while (!C0654lists.isNull(p)) {
                try {
                    Pair pp = (Pair) p;
    ...
    public static Object tokenizeStringToStringArray(String string) {
        ...
        while (toks.hasMoreTokens()) {
            lList = C0654lists.cons(toks.nextToken(), lList);
        }
        try {
            int count = C0654lists.length(lList);
            String[] arr = new String[count];
            int i = count - 1;
            Object p = lList;
            while (!C0654lists.isNull(p)) {
    ...
    /* renamed from: catch  reason: not valid java name */
    public static Object m35catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m35catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
