...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7495Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5820Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7497Z(double layer) {
        this.zLayer = layer;
